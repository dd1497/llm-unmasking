...
MODEL_SAVE_PATH="models/conll2003chunk/my-mwe-roberta-decoder-from-pretrained-unlock-attention"
TASK_TYPE="token_clf"
SEEDS=(120 121 122 123 124)
NAME="my_mwe_roberta_base_decoder_conll2003chunk_from_pretrained_unlock_attention_all"
IS_DECODER=False
