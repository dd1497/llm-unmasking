...
PRETRAINED_MODELS_SAVED_PATH="models/bookcorpus/my-mwe-roberta-decoder-pretrain"
MODEL_SAVE_PATH="models/absa-restaurants/my-mwe-roberta-decoder-from-pretrained-unlock-attention"
TASK_TYPE="token_clf"
SEEDS=(120 121 122 123 124)
NAME="my_mwe_roberta_base_decoder_absa-restaurants_from_pretrained_unlock_attention_all"
IS_DECODER=False
