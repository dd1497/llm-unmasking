...
MODELS_SAVED_PATH="models/conll2003chunk/my-mwe-roberta-encoder-from-pretrained"
SPLIT="validation"
TASK_TYPE="token_clf"
NAME="evaluate_my_mwe_roberta_base_encoder_conll2003chunk_from_pretrained_validation"
