...
MODELS_SAVED_PATH="models/absa-restaurants/my-mwe-roberta-encoder-from-pretrained"
SPLIT="validation"
TASK_TYPE="token_clf"
NAME="evaluate_my_mwe_roberta_base_encoder_absa-restaurants_from_pretrained_validation"
