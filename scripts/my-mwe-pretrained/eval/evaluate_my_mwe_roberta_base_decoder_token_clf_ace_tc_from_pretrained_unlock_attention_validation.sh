...
BATCH_SIZE=256
DATASET_NAME="ace-tc"
MODELS_SAVED_PATH="models/ace-tc/my-mwe-roberta-decoder-from-pretrained-unlock-attention"
SPLIT="validation"
TASK_TYPE="token_clf"
NAME="evaluate_my_mwe_roberta_base_decoder_ace-tc_from_pretrained_unlock_attention_validation"
