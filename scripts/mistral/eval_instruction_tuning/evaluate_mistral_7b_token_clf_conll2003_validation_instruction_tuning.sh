...
MODELS_SAVED_PATH="models/conll2003/mistral-7b-instruction-tuning-latest"
SPLIT="validation"
NAME="evaluate_mistral_7b_conll2003_validation_instruction_tuning_batched_latest"
