...
MODELS_SAVED_PATH="models/absa-restaurants/mistral-7b-instruction-tuning-latest"
SPLIT="validation"
NAME="evaluate_mistral_7b_absa-restaurants_validation_instruction_tuning_batched_latest"
