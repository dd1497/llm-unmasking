...
DO_LOWER_CASE=False
BATCH_SIZE=16
DATASET_NAME="conll2003pos"
BASE_MODEL_NAME="mistral"
MODELS_SAVED_PATH="models/conll2003pos/mistral-7b-unlock-attention"
SPLIT="validation"
TASK_TYPE="token_clf"
NAME="evaluate_mistral_7b_conll2003pos_validation_unlock_attention"
