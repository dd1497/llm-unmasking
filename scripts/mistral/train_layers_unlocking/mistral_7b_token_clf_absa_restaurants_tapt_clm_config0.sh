...
MODEL_SAVE_PATH="models/absa-restaurants/mistral-7b-layers-unlocking-from-tapt-clm-config-0"
TASK_TYPE="token_clf"
SEEDS=(120 121 122 123 124)
NAME="mistral_7b_absa-restaurants_layers_unlocking_tapt_clm_config0"
TAPT="from-tapt-clm-config-0"
