...
MODELS_SAVED_PATH="models/conll2003chunk/llama2-7b-instruction-tuning-latest"
SPLIT="validation"
NAME="evaluate_llama2_7b_conll2003chunk_validation_instruction_tuning_batched_latest"
