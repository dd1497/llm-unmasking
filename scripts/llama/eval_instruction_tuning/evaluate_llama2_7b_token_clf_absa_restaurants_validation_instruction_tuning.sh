...
MODELS_SAVED_PATH="models/absa-restaurants/llama2-7b-instruction-tuning-latest"
SPLIT="validation"
NAME="evaluate_llama2_7b_absa-restaurants_validation_instruction_tuning_batched_latest"
