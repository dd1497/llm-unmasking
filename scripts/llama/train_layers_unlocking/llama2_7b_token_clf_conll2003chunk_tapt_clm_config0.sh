...
MODEL_SAVE_PATH="models/conll2003chunk/llama2-7b-layers-unlocking-from-tapt-clm-config-0"
TASK_TYPE="token_clf"
SEEDS=(120 121 122 123 124)
NAME="llama2_7b_conll2003chunk_layers_unlocking_tapt_clm_config0"
